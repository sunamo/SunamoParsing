...
public class ListParser
{
    ...
    {
        if (o.Count > p) return StaticParse.GetString(o, p);
        return string.Empty;
    }
    ...
    {
        if (o.Count > p) return StaticParse.GetInt(o, p);
        return 0;
    }
    ...
    {
        if (o.Count > p) return StaticParse.GetFloat(o, p);
        return -1;
    }
    ...
    {
        if (o.Count > p) return StaticParse.GetLong(o, p);
        return -1;
    }
    ...
    {
        if (o.Count > p) return StaticParse.GetBoolMS(o, p);
        return false;
    }

    protected bool GetBool(int p)
    {
        if (o.Count > p) return StaticParse.GetBool(o, p);
        return false;
    }
    ...
    {
        if (o.Count > p) return StaticParse.GetBoolS(o, p);
    ...
    /// </summary>
    /// <param name="p"></param>
    protected DateTime GetDateTime(int p)
    {
        if (o.Count > p) return StaticParse.GetDateTime(o, p);
    ...
    {
        if (o.Count > p) return StaticParse.GetDateTimeS(o, p);
        return DateTime.MaxValue.ToString();
    }

    protected byte[] GetImage(int p)
    {
        if (o.Count > p) return StaticParse.GetImage(o, p);
        return new byte[0];
    }
    ...
    {
        if (o.Count > p) return StaticParse.GetDecimal(o, p);
        return -1;
    }
    ...
    {
        if (o.Count > p) return StaticParse.GetDouble(o, p);
        return -1;
    }
    ...
    {
        if (o.Count > p) return StaticParse.GetShort(o, p);
        return -1;
    }
    ...
    {
        if (o.Count > p) return StaticParse.GetByte(o, p);
        return 0;
    }
    ...
    {
        if (o.Count > p) return StaticParse.GetGuid(o, p);
        return Guid.Empty;
    }
